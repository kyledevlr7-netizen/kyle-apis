// tweet_image_generator_dark.js

const { createCanvas, loadImage } = require('@napi-rs/canvas');

const meta = {
  name: 'Tweet Dark Mode',
  desc: 'Generate a high-quality, professional image mimicking a Twitter post design in dark mode with dynamic height based on text content',
  method: ['get', 'post'],
  category: 'canvas',
  params: [
    {
...
async function onStart({ req, res }) {
  ...
  try {
    ...
    if (avatar_url) {
      ...
      // Default professional placeholder: a dark gray circle
      avatar = createCanvas(60, 60);
      const avatarCtx = avatar.getContext('2d');
      avatarCtx.fillStyle = '#333333';
      avatarCtx.beginPath();
    ...
    ctx.fillStyle = '#16181C'; // Darker gray for professional look
